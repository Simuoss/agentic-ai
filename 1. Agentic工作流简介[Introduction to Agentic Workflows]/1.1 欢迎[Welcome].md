...
本课程将详细解释这一点，并教你如何精通构建这些基于代理的工作流。


## 三、智能体 AI 的实际应用场景示例

1、客户支持代理 (**Agentforce - Salesforce**)：用于构建客户支持代理。
示例：用户上传一张家电照片，AI代理能识别设备型号、序列号，并主动提供注册和固件更新服务。

2、深度研究代理 (Claude Research - Anthropic)：用于进行深入研究，撰写有深度的研究报告。
